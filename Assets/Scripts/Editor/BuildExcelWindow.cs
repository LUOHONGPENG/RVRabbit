...
{
    [MenuItem("RabbitTools/Excel Window")]
    ...
    private void GetExcelFile()
    {
        ...
        {
            showNotify = "WrongPath：" + ExcelDataReader.excelFilePath;
            return;
        }
        ...
        {
            showNotify = ExcelDataReader.excelFilePath + "No Excel File";
            return;
        }
